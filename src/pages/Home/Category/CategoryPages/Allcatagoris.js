    ...
    <div className="mx-10 my-12">
      ...
      <section className="grid grid-cols-6">
        <div className="flex flex-col items-center mb-4">
          <Link to={"/catagoris/mansfashion"} className="bg-slate-50 p-6  mb-4">
            <img className="h-32 w-32" src={manPic} alt="Man Fashion" />
          </Link>
        ...
        <div className="flex flex-col items-center mb-4">
          <Link to={"/catagoris/gadget"} className="bg-slate-50 p-6  mb-4">
            <img
              className="h-32 w-32"
              src={gadgetPic}
              alt="gadget electronic"
            />
          </Link>
        ...
        <div className="flex flex-col items-center mb-4">
          <Link to={"/catagoris/voucher"} className="bg-slate-50 p-6  mb-4">
            <img className="h-32 w-32" src={voucherPic} alt="voucher game" />
          </Link>
        ...
        <div className="flex flex-col items-center mb-4">
          <Link to={"/catagoris/property"} className="bg-slate-50 p-6  mb-4">
            <svg
              className="h-32 w-32"
              viewBox="0 0 32 32"
              fill="none"
        ...
        <div className="flex flex-col items-center mb-4">
          <Link to={"/catagoris/kidsfashion"} className="bg-slate-50 p-6  mb-4">
            <svg
              className="h-32 w-32"
              viewBox="0 0 32 32"
              fill="none"
        ...
        <div className="flex flex-col items-center mb-4">
          <Link
            ...
            className="bg-slate-50 p-6  mb-4"
          >
            <svg
              className="h-32 w-32"
              viewBox="0 0 32 32"
        ...
        <div className="flex flex-col items-center mb-4">
          <Link to={"/catagoris/sports"} className="bg-slate-50 p-6  mb-4">
            <svg
              className="w-32 h-32"
              viewBox="0 0 27 27"
              fill="none"
        ...
        <div className="flex flex-col items-center mb-4">
          <Link to={"/catagoris/game"} className="bg-slate-50 p-6  mb-4">
            <svg
              className="h-32 w-32"
              viewBox="0 0 32 32"
              fill="none"
        ...
        <div className="flex flex-col items-center mb-4">
          <Link to={"/catagoris/flim&music"} className="bg-slate-50 p-6  mb-4">
            <svg
              className="h-32 w-32"
              viewBox="0 0 32 32"
              fill="none"
